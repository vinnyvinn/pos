...
<body>
  ...
  <table class="table">
    <tbody>Sales
      ...
      <tr>
          <th style="padding-left:-10px; text-align: left">Item</th><th>Quantity</th><th>Price</th><th>VAT</th><th style="padding-right:20px; text-align: right">Amount Icl</th>
      </tr>
      ...
      <tr><td colspan="5" style="padding-left:-10px; text-align: left">TOTAL ITEMS: {{ count($sale->sale->toArray()) }}</td></tr>
    </tbody>
  </table>
  <table class="table">
    <thead>
